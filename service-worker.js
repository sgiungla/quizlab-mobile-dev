const CACHE='quizlab-mobile-dev-v0.5.8';
const ASSETS=['./','./index.html','./styles.css','./app.js','./db.js','./sync-adapter.js','./cloud-config.js','./manifest.webmanifest','./icons/icon.svg'];
